...
joey = User.create(username: "joey", email: "joey@gmail.com", password: "password", bio: "Joey is a test user without admin priviledges. Joey is fictitious and has been created for testing purposes only.")
